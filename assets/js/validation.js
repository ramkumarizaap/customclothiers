	...
	$("#review-form").validate({
...

		{
			...
			/*$.ajax({
		    			...
		    			type:"POST",url:"http://otkootoor.com/includes/action/action.php",
...

		    			{
		    				...
		    				$(".post-msg").html("Review Added Successfully");
