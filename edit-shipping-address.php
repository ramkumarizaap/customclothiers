      ...
      <div class="container">
          ...
          <section class="row">
              ...
              <div class="col-sm-9 space-left-30">
                <?php 
                //$shipping_address_id = (isset($_SESSION['shipping_address_id']) && $_SESSION['shipping_address_id']!='')?'and sa_id='.$_SESSION['shipping_address_id']:'';
                 $sql1=$site->select_query("select * from shipping_address where userid='".$_SESSION['user_id']."' order by sa_id desc limit 1");
                    $firstname=$sql1[2];$lastname=$sql1[3];$address1=$sql1[4];$address2=$sql1[5];
                    $city=$sql1[6];$state=$sql1[7];$zipcode=$sql1[9];
                    $country=$sql1[8];
                    ?>
                  <h2 class="strong-header large-header">Edit Shipping Address</h2>
                  <div class="row">
                    <form action="<?php echo $homeurl;?>includes/action/action.php" method="post">
                        ...
                        <div class="col-xs-12">
                            <div class="form-group">
                               ...
                               <select class="chosen chosen-select-deselect form-control" id="state" required data-placeholder=" "  tabindex="1" name="state">
                        ...
                        <div class="col-xs-12">
                          <div class="form-group nation">
                            <button type="submit" name="update_shipping_addr" class="ship-address btn btn-primary pull-left">Save</button>
                          </div>
                        </div>
                      </form>
                  </div>
