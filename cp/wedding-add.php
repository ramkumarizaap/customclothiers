   ...
   if(isset($_GET['type']))
    {
      ...
      $id=$_GET['type'];
      $wed=$site->get_wedding($id);
      $id=$wed[0]['id'];
      $name=$wed[0]['title'];$image=$wed[0]['img'];
      $desc=$wed[0]['desc'];
      $button="Update";
      $tit="Edit";
      $action="update";
    ...
    <div class="wrapper">
        <div class="content-wrapper">
             <section class="content-header">
                 <h1>Wedding <?php echo $tit;?> Form</h1>
                      <ol class="breadcrumb">
                        <li><a href="<?php echo $adminurl;?>dashboard/"><i class="fa fa-dashboard"></i> Home</a></li>
                        <li class="active">Wedding Form</li>
                     </ol>
                </section>
                        ...
                        <div class="modal-dialog">
                          <div class="modal-content">
                            <div class="modal-header">
                              <button type="button" class="close close-btn" onclick='window.location.href="<?php echo $adminurl;?>wedding/";' aria-label="Close"><span aria-hidden="true">×</span></button>
                            ...
                            <div class="modal-footer">
                              <a href="javascript:void(0);" data-href="modal1" class="popup save" style="display:none;">asd</a>
                              <button type="button" class="btn btn-default pull-right" onclick='window.location.href="<?php echo $adminurl;?>wedding/";'>Close</button>
                            </div>
                          </div><!-- /.modal-content -->
                        </div><!-- /.modal-dialog -->
                      </div><!-- /.modal -->
