...
<body class="skin-black sidebar-mini">
    <div class="wrapper">
        <div class="content-wrapper">
                ...
                <a href="<?php echo $adminurl;?>quotes-add/" class="btn btn-primary pull-left" style="margin-left: 10px;"><i class="fa fa-plus"></i>&nbsp; Add Quotes</a>
                <br /><br />
                ...
                <div class="box-body">
                  <table id="example1" class="table table-bordered table-striped">
                    ...
                    {
                      $st=$qt[$key]['status'];$id=$qt[$key]['id'];
                    ?>
                      <tr>
                       
                        <td>
                          <!--<span class="col-md-4"><img src="<?php echo $homeurl.$image[0];?>" height="60"></span>-->
                          <span class="col-md-8"><?php echo $qt[$key]['text'];?></span>
                          </td>
                        <td>
                          <?php echo $qt[$key]['name'];?><br>
                          <?php echo $qt[$key]['mail'];?>
                        </td>
                        <td><?php if($st=="1"){?>
                            <a href="javascript:void;" class="btn btn-danger do_visible hide" 
                            data-table="quote_master" data-id="<?php echo $id;?>" data-where="qid" data-field="status" 
                                  data-value="1"><i class="ion ion-close"></i></a>
                            <a href="javascript:void;" class="btn btn-success do_visible" data-table="quote_master" 
                            data-id="<?php echo $id;?>" data-where="qid" data-field="status" data-value="0">
                              <i class="ion ion-checkmark"></i></a>
                          <?php }else{?>
                          <a href="javascript:void;" class="btn btn-danger do_visible" data-where="qid" data-table="quote_master" data-id="<?php echo $id;?>"
                             data-field="status" data-value="1"><i class="ion ion-close"></i></a>
                            <a href="javascript:void;" class="btn btn-success hide do_visible" data-where="qid" data-table="quote_master" data-id="<?php echo $id;?>"
                            data-field="status" data-value="0"><i class="ion ion-checkmark"></i></a>
                          <?php }?>
                        </td>
                        <td><?php echo date('m-d-Y h:i:s a',strtotime($qt[$key]['created_date']));?></td>
                        <td>
                            <a href="<?php echo $adminurl;?>quotes-add/<?php echo $id;?>/" class="btn btn-primary"><i class="fa fa-edit"></i></a>
                            ...
                            <div class="modal">
                              <div class="modal-dialog">
                                <div class="modal-content">
                                  ...
                                  <button type="button" data-table="quote_master" data-field="qid" 
