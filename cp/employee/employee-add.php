                ...
                <section class="content">
                        ...
                        <div class="box box-primary">
	                        ...
	                        <!-- form start -->
	                          ...
	                          <div class="box-body">
	                            ...
	                            <div class="form-group">
			                              ...
			                              <input type="text" class="form-control" name="vendor_name" placeholder="Enter Employee Name"
	                      ...
	                      <div class="row">
	                            ...
	                            <button type="button" class="btn btn-info" onClick="window.location.href='<?php echo $adminurl;?>employees/';">Cancel</button>
		                        ...
		                        <div class="modal-dialog">
		                          ...
		                          <div class="modal-content">
		                            ...
		                            <div class="modal-header">
		                              ...
		                              <button type="button" class="close close-btn" onclick='window.location.href="<?php echo $adminurl;?>employees/";' aria-label="Close"><span aria-hidden="true">×</span></button>
		                            ...
		                            <div class="modal-body popup-body">
		                              ...
		                              <p>Employee Details has been successfully saved!!!</p>

		                            </div>

		                            <div class="modal-footer">

		                              <button type="button" class="btn btn-default pull-right" onclick='window.location.href="<?php echo $adminurl;?>employees/";'>Close</button>
