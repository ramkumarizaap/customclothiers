                  ...
                  <div class="row">
                    ...
                    <div class="col-md-8">
                      ...
                      <div class="box box-primary">
                        ...
                        <input type="hidden" name="type" value="property_style">
                        ...
                        <input type="hidden" value="<?php echo $id;?>" name="id">
                          ...
                          <div class="box-body">
                           ...
                           <div class="form-group">
                              ...
                              <label for="exampleInputEmail1">Label Title</label>



                              <input type="text" class="form-control" name="label_name" value="<?php echo $name;?>" placeholder="Enter Title of Label">
                        ...
                        <div class="modal-dialog">
                          ...
                          <div class="modal-content">
                            ...
                            <div class="modal-header">
                              ...
                              <button type="button" class="close close-btn" onclick='window.location.href="<?php echo $adminurl;?>labels/";' aria-label="Close"><span aria-hidden="true">×</span></button>
                            ...
                            <div class="modal-body popup-body">
                              ...
                              <p>Labels has been save successfully!!!</p>
                            ...
                            <div class="modal-footer">
                              ...
                              <button type="button" class="btn btn-default pull-right" onclick='window.location.href="<?php echo $adminurl;?>labels/";'>Close</button>
