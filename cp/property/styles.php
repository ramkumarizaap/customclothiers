        ...
        <div class="content-wrapper">
                  <section class="content-header">
                      ...
                      <ol class="breadcrumb">
                        ...
                        <li class="active">Label Styles</li>
                      </ol>
                </section><br />
                <!--<a href="<?php echo $adminurl;?>styles-add/" class="btn btn-primary pull-left" style="margin-left: 10px;"><i class="fa fa-plus"></i>&nbsp; Add Label Style</a>-->
                <br /><br />
                ...
                <div class="box-body">
                  <table id="example1" class="table table-bordered table-striped">
                    <thead>
                      <tr>
                        <th  width="150">Property Label</th>                        
                        <th width="300">Sub Category</th>
                        <th width="150">Styles</th>
                        <th>Created Date</th>
                    ...
                    <tbody>
                    <?php $i=0;
                    $pros=$site->get_properties_styles();
                    if($pros)
                    {
                    ...
                    ?>
                      <tr>
                        ...
                        <td><?php echo $pros[$key]['value'];?></td>
                        <td><?php echo date('m-d-Y h:i:s a',strtotime($pros[$key]['created_date']));?></td>
                        <td>
                            <a href="<?php echo $adminurl;?>styles-add/<?php echo $id;?>/" class="btn btn-primary"><i class="fa fa-edit"></i></a>
                            ...
                            <div class="modal">
                              <div class="modal-dialog">
                                <div class="modal-content">
                                  ...
                                  <button type="button" data-table="property_style_details" data-field="psd_id" data-id="<?php echo $id;?>"  style="margin-left:10px;" class="btn btn-danger pull-right delete-data">Delete</button>  
