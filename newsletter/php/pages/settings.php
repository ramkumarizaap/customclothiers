...
<a href="https://<?php echo $newsletter->base_href;?>/ext.php?t=update_form">https://<?php echo $newsletter->base_href;?>/ext.php?t=update_form</a> Update your details link {LINK_ACCOUNT} template <br>

<a href="https://<?php echo $newsletter->base_href;?>/ext.php?t=signup_form">https://<?php echo $newsletter->base_href;?>/ext.php?t=signup_form</a> Signup to newsletter link (eg: to iframe)<br>
...
<table cellpadding="5">
	...
	<tr>
		...
		<td valign="top">
			...
			<textarea cols="60" class="input" rows="20"><?php echo htmlspecialchars('<form action="https://'.$newsletter->base_href.'/ext.php?t=signup" method="post">'.$form.'</form>');?></textarea>
