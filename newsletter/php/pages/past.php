	...
	<table cellpadding="5">
		...
		<tr>
			...
			<td>
				...
				<a href="?p=open&newsletter_id=<?php echo $n['newsletter_id'];?>" title="Stats/Send"><i class="fa fa-share-square-o btn btn-small share"></i></a>

				<a href="?p=create&newsletter_id=<?php echo $n['newsletter_id'];?>" title="Edit"><i class="fa fa-pencil-square-o btn btn-small pencil"></i></a>
