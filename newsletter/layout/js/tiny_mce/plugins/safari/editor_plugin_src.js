...
(function() {
	...
	tinymce.create('tinymce.https://.Safari', {
...
*/
	...
	/*		ed.onKeyDown.add(function(ed, e) {
		...
		getInfo : function() {
			...
			return {
				...
				infourl : 'https://wiki.moxiecode.com/index.php/TinyMCE:https:///safari',
	...
	tinymce.PluginManager.add('safari', tinymce.https://.Safari);
