...
if(isset($_POST['p_id']))
...

 {
    ...
    $_SESSION['p_dtl'] = array('sub_cat_id' => $get_sub_cat[0]['id'],'sub_category' => $get_sub_cat[0]['subcat_name'],'category' => $get_sub_cat[0]['category_name'],'base_price'=>$price,'p_id'=>$p_id,'p_img_dtl' =>$p_img_dtl,'waistcoat_price' =>$waistcoat_price,'extra_pant_price' => $extra_price );
