...
$pro_id=$site->get_product_by_name($id);
...
<header>
  ...
  <a href="#reviews">
  <?php echo $r_count=$site->get_counts("reviews",$pro_id[0]['id']);?> reviews</a>
...
<form role="form" class="shop-form form-horizontal" id="customize-form" action="<?php echo $homeurl; ?>customize/<?php echo strtolower(str_replace(' ','-',$get_sub_cat[0]['subcat_name'])); ?>/" method="post" novalidate>
  ...
  <!--
                            -->
  <?php
    if($pro_id[0]['product_name'] == 'Dress1' || $pro_id[0]['product_name'] == 'Dress2')
    {
      $customizer_url='#';
    }
    else {
      $customizer_url=$homeurl."customize/".$pro_id[0]['id']."/";
    }
  ?>
                        ...
                        <div class="panel panel-default">
                          ...
                          <div id="collapse-001" class="panel-collapse collapse in">
                            ...
                            <div class="panel-body">
                              ...
                              <div class="filters-range" data-min="10" data-max="3200" data-step="5">
                              ...
                              <div id="collapse-002" class="panel-collapse collapse in">
                                ...
                                <div class="panel-body">
                                  ...
                                  <div class="filters-checkboxes myFilters" data-option-group="category" data-option-type="filter">
                                    ...
                                    $sql=mysqli_query($con,"select a.fabid from product_master a,sub_category_master b where a.subcatid=b.sub_cat_id and b.sub_cat_name='$sub'");
                                    $r=mysqli_fetch_array($sql);
                                    $fab=$site->get_fabrics1('',$r['fabid']);
            ...
            <ul class="dropdown-menu" role="menu">
              ...
              <li>
               ...
               <li>
                ...
                <a href="javascript:void(0);" class="isotopeFilter" data-option-value="price" data-option-asc="false">
      ...
      <div class="col-xs-12">
        ...
        <div id="isotopeContainer" class="shop-product-list isotope">
            ...
            <?php
              ...
              $pro=$site->get_all_products('','','','',str_replace("-"," ",$catid),str_replace("-"," ",$subcatid));
              //exit;
              //print_r($pro);
          ...
          <div class="isotope-item  <?php echo $f_name;?> size1 size2 <?php echo str_replace(" ","-",strtolower($pro[$key]['sub_cat_name']));?>" data-date="January 1, 2012" data-popular="40" data-rating="4.0">
